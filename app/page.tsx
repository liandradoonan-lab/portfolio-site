export default function HomePage() {
  return (
    // Two columns on desktop, stacked on mobile. Sits high on the page rather
    // than centred in the viewport — more sections go underneath.
    <section className="grid items-start gap-10 sm:grid-cols-[1.15fr_1fr] sm:gap-12">
      <div>
        <h1
          // Fraunces, same as every other page's heading — the display cut and
          // tracking come from the h1 rule in globals.css.
        ...
        <p className="mt-6 max-w-md text-lg leading-relaxed text-ash">
          Senior full-cycle Recruiter, People Ops Generalist and crazy dog mom
        </p>
      </div>
